...
| status          | enum - uploading, uploaded, processing, chunking, embedding, ready, failed | yes      | used to provide status on document upload process as chunking and embedding is asynchronous |
